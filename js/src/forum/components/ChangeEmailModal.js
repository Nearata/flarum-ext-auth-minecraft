...
const trans = (key, options = {}) => {
    return app.translator.trans(`nearata-auth-minecraft.forum.change_email_modal.${key}`, options);
}
...
export default class ChangeEmailModal extends Modal {
    ...
    content() {
            ...
            return [
                m('.Modal-body', [
                    m('.Form.Form--centered', [
                        m('p.helpText', [
                            trans('confirmation_message', {email: m('strong', this.email())})
                        ]),
                        m('.Form-group', [
                            m(Button, {
        ...
        return [
            m('.Modal-body', [
                m('.Form.Form--centered', [
                    m('p.helpText', app.translator.trans('nearata-auth-minecraft.forum.token_help')),
                    m('.Form-group', [
                        m('input', {
